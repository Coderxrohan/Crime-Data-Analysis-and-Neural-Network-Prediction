# -*- coding: utf-8 -*-
"""Crime Data Analysis and Neural Network Prediction.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1RuP6fzEBkV7wJAFNpGguFZnimODE2pZA
...
**Note :**
This will connect my Google Drive files to Google collab. Hence my files wont be deleted after this session expirtaion. Becomes easy to share and navigate.
"""
...
#loading the dataset
df = pd.read_csv('/content/drive/MyDrive/Community_Crime_Statistics_20240522.csv')
df.head()
